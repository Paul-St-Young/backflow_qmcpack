          ...
          if (jastfunction == "mcmillanj2g")
          {
            ...
            if (jastfunction == "gaussian")
            {
              ...
              if (jastfunction == "shiftedgaussian")
              {
                ...
                if (jastfunction == "padetwo2ndorderfunctor")
                {
 ...
 * $Revision: 5875 $   $Date: 2013-05-30 11:10:06 -0700 (Thu, 30 May 2013) $
